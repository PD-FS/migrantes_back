...
class DonationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post donations_url, params: { donation: { date_donation: @donation.date_donation, donate: @donation.donate, need_id: @donation.need_id, user_id: @donation.user_id } }
    end
  ...
  test "should update donation" do
    patch donation_url(@donation), params: { donation: { date_donation: @donation.date_donation, donate: @donation.donate, need_id: @donation.need_id, user_id: @donation.user_id } }
